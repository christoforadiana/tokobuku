...
class Admin_model extends CI_Model
{
    ...
    public function getBukuMasuk($limit = null, $id_buku = null, $range = null)
    {
        ...
        $this->db->join('buku b', 'bm.buku_id = b.id_buku');
        if ($limit != null) {
            $this->db->limit($limit);
        }
        ...
        $this->db->order_by('id_buku_masuk', 'DESC');
        return $this->db->get('buku_masuk bm')->result_array();
    }
    ...
    public function getBukuKeluar($limit = null, $id_buku = null, $range = null)
    {
        ...
        $this->db->join('buku b', 'bk.buku_id = b.id_buku');
        if ($limit != null) {
            $this->db->limit($limit);
        }
        if ($id_buku != null) {
        ...
        $this->db->order_by('id_buku_keluar', 'DESC');
        return $this->db->get('buku_keluar bk')->result_array();
    }
